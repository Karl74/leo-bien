...
export default class LessonDisplay extends Component {
  ...
  render() {
    return (
      <div className="jumbotron bg-transparent text-center mx-auto py-3">
        <AppConsumer>
          {value=>{
          ...
          <div className="card border-warning bg-transparent">
            <div className="card-body">
              <h1 className="lesson-text" style={{minHeight:"11rem"}}>{text}</h1>
              <div className="d-flex justify-content-between">
                <SidebarBtn name="anterior" action={value.prevSlide}/>
                <svg onClick={()=>playAudio()} className="bi bi-volume-up text-light soundIcon" width="4em" height="4em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
